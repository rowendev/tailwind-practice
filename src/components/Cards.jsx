...
const Cards = () => {
  return (
    <div className="w-full py-[10rem] px-8 md:px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-2xl flex flex-col py-4 my-4 rounded-lg md:hover:scale-105 duration-300">
          <img
        ...
        {/* 2 */}
        <div className="w-full shadow-2xl bg-gray-100 flex flex-col py-4 my-8 md:my-0 rounded-lg md:hover:scale-105 duration-300">
